...
const PastorFormEditContainer = () => {
    ...
    useEffect(() => {
        ...
        const getPastor = async() => {
            try{
            const {data} = await requestAxios.get(`/pastors/${id}`, {cancelToken:source.token});
            setPastor(data.body);
            }catch(err){
                console.error(err);
          ...
          {() => (
               ...
               <div className="form-row">                
                ...
                <div className="form-group mt-5">
                     <input type="submit" value="UPDATE PASTOR" className="btn btn-primary btn-lg mr-3" />
...
export default PastorFormEditContainer;